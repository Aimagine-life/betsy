<p align="center">
  <img src="docs/assets/logo.png" alt="Betsy" width="120" />
</p>
...
<!-- 📸 СКРИНШОТ: примеры 2-3 разных личностей — разные имена, разные аватарки, разные стили ответов в чате -->
...
<!-- 📸 СКРИНШОТ: Telegram — Бетси прислала селфи с комментарием -->
